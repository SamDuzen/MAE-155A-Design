...
We = 2400; % empty weight [kg] ---> added up all of empty weights to and divided it by 9.81 m/s^2 to get kg 
...
for i = 1:length(production_quantities)
  production_cost8(i) = Cm_mks * production_quantities(i)^(log10(learning_rate)/log10(2));
  production_cost9(i) = Cm_mks * production_quantities(i)^(log10(0.9)/log10(2));
  production_cost95(i) = Cm_mks * production_quantities(i)^(log10(0.95)/log10(2));
  production_cost7(i) = Cm_mks * production_quantities(i)^(log10(0.7)/log10(2));
  production_cost6(i) = Cm_mks * production_quantities(i)^(log10(0.6)/log10(2));
end
